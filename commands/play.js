...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (serverQueue) {
      ...
      .setAuthor("Song has been added to queue", "https://i.gifer.com/24BU.gif")
    ...
    const play = async (song) => {
      ...
      if (!song) {
        sendError("Thanks for using me!", message.channel)
      ...
      let thing = new MessageEmbed()
      .setAuthor("Started Playing Music!", "https://i.gifer.com/24BU.gif")
      .setThumbnail(song.img)
      .setColor("ORANGE")
      .addField("Name", song.title, true)
      .addField("Duration", song.duration, true)
